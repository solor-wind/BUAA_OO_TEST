    ...
    for i in range(0, len(actions)):
        ...
        match action[1]:
            ...
            case 'RESET_BEGIN':
                ...
                elevators[action[2]].reset.append(action)
            case 'RESET_END':
                if elevators[action[2]].reset.__len__() != 2 or not (
                        'RESET_ACCEPT' in elevators[action[2]].reset[0] and 'RESET_BEGIN' in elevators[action[2]].reset[
                    1]):
                ...
                elif action[0] - elevators[action[2]].reset[1][0] > 1.2 + tolerance or action[0] - \
                        elevators[action[2]].reset[1][0] < 1.2 - tolerance:  # 有容错
